                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <div class="form-check mt-4">
                                                <input class="form-check-input" type="checkbox" id="is_free" name="is_free" {{ old('is_free') ? 'checked' : '' }} onchange="togglePriceField()">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <small class="form-text text-muted">Upload PDF file for free books (optional)</small>
                                            @error('pdf_file')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
